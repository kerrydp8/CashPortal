...
namespace CashPortal.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Amount,BudgetId")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Amount,BudgetId")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
